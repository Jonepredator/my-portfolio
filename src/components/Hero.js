...
const HeroContent = styled.div`
    ...
    h1 {
      ...
      text-shadow: 0.5px 0.5px 20px rgba(0, 0, 0, 0.4);
      text-align: left;
      ...
      <HeroSection>
         <HeroWrapper>
            ...
            <HeroContent>
               ...
               <br />
               <h3 data-aos='fade-right' data-aos-duration='1600' data-aos-delay='2000' >Currently searching for an internship <br /> from mid November to April</h3>
            </HeroContent>
         </HeroWrapper>
      </HeroSection>
   );
